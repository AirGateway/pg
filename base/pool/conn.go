...
func (cn *Conn) WithReader(
	...
	return base.WithSpan(ctx, "with_reader", func(ctx context.Context, span trace.Span) error {
...
func (cn *Conn) WithWriter(
	...
	return base.WithSpan(ctx, "with_writer", func(ctx context.Context, span trace.Span) error {
		wb := GetWriteBuffer()
